                ...
                <div class="container">
                    ...
                    <form action="LoginController.jsp" method = "post">
                        <table style="text-align: center;">
                            ...
                            <tr>
                                <td colspan="2"><button class="btn btn-dark">Login</button></td>
                            </tr>
                        </table>
                    </form>
                </div>
                    ...
                    <form action="SignupController.jsp" method="post">
                        <table>
                            ...
                            <tr>
                                ...
                                <td><input type="password" name="confirmpassword" id="pwd"></td>
                            </tr>
                            <tr>
                                <td colspan="2"><button class="btn btn-dark">Sign Up</button></td>
                            </tr>
                        </table>
                    </form>
                </div>
